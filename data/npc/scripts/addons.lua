...
function playerBuyAddonNPC(cid, message, keywords, parameters, node)
	...
	if parameters.confirm then
		...
		if player:getMoney() >= addoninfo.cost and (items_number == table.maxn(addoninfo.items)) then
            if player:removeMoney(addoninfo.cost) then
				if table.maxn(addoninfo.items) > 0 then
					for i = 1, table.maxn(addoninfo.items) do
						local item = addoninfo.items[i]
						if player:removeItem(item[1],item[2]) then end
					end
				end
				player:addOutfitAddon(addoninfo.outfit_male, addoninfo.addon)
				player:addOutfitAddon(addoninfo.outfit_female, addoninfo.addo)
...
local outfit_node = keywordHandler:addKeyword({'first druid addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{5896,50}, {5897,50}}, outfit_female = 148, outfit_male = 144, addon = 1, storageID = 10013})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second druid addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{5906,100}, {5938,1}, {5940,1}}, outfit_female = 148, outfit_male = 144, addon = 2, storageID = 10014})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)
...
local outfit_node = keywordHandler:addKeyword({'first warmaster addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{11112,1}}, outfit_female = 336, outfit_male = 335, addon = 1, storageID = 10042})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second warmaster addon'}, playerBuyAddonNPC, {premium = false, cost = 0, items = {{11111,1}}, outfit_female = 336, outfit_male = 335, addon = 2, storageID = 10043})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)
 
-- wayfarer (done)(custom)
local outfit_node = keywordHandler:addKeyword({'first wayfarer addon'}, playerBuyAddonNPC, {premium = false, cost = 500000, items = {}, outfit_female = 366, outfit_male = 367, addon = 1, storageID = 10044})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)
local outfit_node = keywordHandler:addKeyword({'second wayfarer addon'}, playerBuyAddonNPC, {premium = false, cost = 1000000, items = {}, outfit_female = 366, outfit_male = 367, addon = 2, storageID = 10045})
    outfit_node:addChildKeywordNode(yesNode)
    outfit_node:addChildKeywordNode(noNode)
